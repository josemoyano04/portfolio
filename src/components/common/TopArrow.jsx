...
export function TopArrow({ redirectTo }) {
    ...
    return (
        <div className='icon'>
            <a href={redirectTo}>
                ...
                15.2929C6.0731 15.6835 6.70626 15.6835 7.09679 15.2929L11.2824 11.1073C11.673 10.7168 12.3061 10.7168 
                12.6966 11.1073L16.8787 15.2893C17.2692 15.6798 17.9024 15.6798 18.2929 15.2893Z"
                    />
                </svg>
            </a>
        </div>
